...
gst-launch-1.0 v4l2src device=/dev/video0 io-mode=mmap num-buffers=300 ! image/jpeg,width=1920,height=1080,framerate=30/1 ! jpegdec ! amlvenc bitrate=2000 ! h264parse ! fakesink
# Place your command here
magic_word="amlvenc"
