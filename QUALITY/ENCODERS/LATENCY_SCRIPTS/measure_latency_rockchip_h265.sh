...
gst-launch-1.0 v4l2src device=/dev/video60 io-mode=mmap num-buffers=300 ! image/jpeg,width=1920,height=1080,framerate=30/1 ! mppjpegdec ! mpph265enc qp-min=10 qp-max=51 bps-min=2000000 bps-max=2000000 gop=
30 header-mode=1 ! h265parse ! fakesink   
# Place your command here
