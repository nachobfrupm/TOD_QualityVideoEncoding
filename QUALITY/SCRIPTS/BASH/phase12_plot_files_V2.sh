...
ROOT_DIR=$SCRIPT_DIR/../..
LIST_OF_COLUMNS_TO_BE_REMOVED="SI,TI,VCA_E,VCA_H,EVCA_SC,EVCA_TC,INFERENCE_TIME,CARS,BICYCLES,MOTORCYCLES,BUSES,TRUCKS,TRAFFIC_LIGHTS,PERSONS,STOPS_SIGNS,BICYCLES_PCT,MOTORCYCLES_PCT,BUSES_PCT,TRUCKS_PCT,TRAFFIC_LIGHTS_PCT,PERSONS_PCT,STOPS_SIGNS_PCT,INFERENCE_TIME_MS,BITRATE"
#LIST_OF_COLUMNS_TO_BE_REMOVED="INFERENCE_TIME_MS,BITRATE"

cd ${INPUT_DIR}

SELECTED_FIELDS="BITRATE VMAF PSNR SI TI SI_PCT TI_PCT P1204_3_MOS VCA_E_PCT VCA_H_PCT EVCA_SC_PCT EVCA_TC_PCT CARS CARS_PCT INFERENCE_TIME_MS COVER_SSC COVER_TSC COVER_ASC COVER_FSC BYCICLES MOTORCYCLES BUSES TRUCKS TRAFFIC_LIGHTS PERSONS STOPS_SIGNS LD_PCT BYCICLES_PCT MOTORCYCLES_PCT BUSES_PCT TRUCKS_PCT TRAFFIC_LIGHTS_PCT PERSONS_PCT STOPS_SIGNS_PCT"
