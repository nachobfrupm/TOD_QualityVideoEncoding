...
echo ""
echo "Plotting scatter files vs Bitrateeeee"
#SELECTED_FIELDS="BITRATE VMAF PSNR SI TI SI_PCT TI_PCT P1204_3_MOS VCA_E VCA_H EVCA_SC EVCA_TC CARS INFERENCE_TIME_MS COVER_SSC COVER_TSC COVER_ASC COVER_FSC BYCICLES MOTORCYCLES BUSES TRUCKS TRAFFIC_LIGHTS PERSONS STOPS_SIGNS BYCICLES_PCT MOTORCYCLES_PCT BUSES_PCT TRUCKS_PCT TRAFFIC_LIGHTS_PCT PERSONS_PCT STOPS_SIGNS_PCT CARS_PCT LD_PCT"
SELECTED_FIELDS="BITRATE VMAF PSNR SI TI SI_PCT TI_PCT P1204_3_MOS VCA_E VCA_H EVCA_SC EVCA_TC CARS INFERENCE_TIME_MS COVER_SSC COVER_TSC COVER_ASC COVER_FSC BYCICLES MOTORCYCLES BUSES TRUCKS TRAFFIC_LIGHTS PERSONS STOPS_SIGNS BYCICLES_PCT MOTORCYCLES_PCT BUSES_PCT TRUCKS_PCT TRAFFIC_LIGHTS_PCT PERSONS_PCT STOPS_SIGNS_PCT CARS_PCT LD_PCT VCA_E_PCT VCA_H_PCT EVCA_SC_PCT EVCA_TC_PCT CARS"
for field in $SELECTED_FIELDS
do
    echo "========================================"
    echo "SELECTED_FIELD: $field"
    echo "========================================"
